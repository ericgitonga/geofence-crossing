...
class RoiPolygonLayer(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class CrossingsTable(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class FormData(BaseModel):
    ...
    subject_obs: Optional[SubjectObs] = Field(None, title="Subject Group Observations")
    subject_tracks: Optional[SubjectTracks] = Field(None, title="Subject Tracks")
    ...
    roi_polygon_layer: Optional[RoiPolygonLayer] = Field(
        None, title="Create ROI Boundary Layer"
    )
    ecomap: Optional[Ecomap] = Field(None, title="Draw Crossings Ecomap")
    crossings_table: Optional[CrossingsTable] = Field(
        None, title="Draw Crossings Table"
    )
